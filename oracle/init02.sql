...
ALTER TABLE pujlab." SOCIAL_NETWORK"
    ADD CONSTRAINT " SOCIAL_NETWORK_USER_FK1" FOREIGN KEY ( user_id_related )
        REFERENCES pujlab."USER" ( id_user );

ALTER TABLE pujlab." SOCIAL_NETWORK"
    ADD CONSTRAINT " SOCIAL_NETWORK_USER_FK2" FOREIGN KEY ( user_id )
        REFERENCES pujlab."USER" ( id_user );
